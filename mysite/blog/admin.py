...
from blog.models import Blog_post,Information,Post_image,Background,VisitorNum
...
class VisitorNum_admin(admin.ModelAdmin):
...
admin.site.register(VisitorNum,VisitorNum_admin)
